package com.travis.filesbottle.report.config;
...
public class SwaggerConfiguration {
    ...
    public Docket groupRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.travis.filesbottle.report.controller"))
