package com.travis.filesbottle.ffmpeg.config;
...
public class SwaggerConfiguration {
    ...
    public Docket groupRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.travis.filesbottle.ffmpeg.controller"))
    ...
    public ApiInfo groupApiInfo(){
        return new ApiInfoBuilder()
                .title("FilesBottle --> ffmpeg模块接口文档")
